...
def test_valid_remove(register_three_users):
    ...
    response = requests.delete(f"{BASE_URL}/message/remove/v1", json = {"token": register_three_users["token"][0], "message_id": message_id})
    assert response.status_code == 200
...
def test_invalid_token(register_three_users):
    ...
    response = requests.delete(f"{BASE_URL}/message/remove/v1", json = {"token": "incorrect token", "message_id": message_id})
...
def test_invalid_message_id(register_three_users):
    ...
    response = requests.delete(f"{BASE_URL}/message/remove/v1", json = {"token": register_three_users["token"][0], "message_id": message_id + 20})
...
def test_not_form_user(register_three_users):
    ...
    response = requests.delete(f"{BASE_URL}/message/remove/v1", json = {"token": register_three_users["token"][1], "message_id": message_id})
    assert response.status_code == 403
