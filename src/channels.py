...
from src.error_help import check_valid_id, check_valid_token, validate_channel, check_channel_priv, check_channel_user, user_not_in_channel
...
def channels_create_v1(token, name, is_public):
    ...
    which_user = check_valid_token(token, store)
